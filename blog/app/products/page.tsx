...
export const metadata = {
    ...
    description: 'Premium AI tools, prompt templates, and resources for vibe-coders.',
    alternates: {
        canonical: '/products/',
    },
}
...
const PRODUCTS = [
    {
        ...
        description: 'A 50-page guide + 20 Copy-Paste templates for Claude 3.5 Sonnet and GPT-4o. Learn to vibe-code like a senior engineer.',
        price: '$19',
    ...
    },
    {
        ...
        description: 'The exact React/Tailwind components used to build this exact blog. 10+ premium, animated components ready for your project.',
        price: '$29',
    ...
    },
    {
        ...
        description: 'My complete configuration files, custom rules, and workflow hacks for dual-wielding the best AI IDEs.',
        price: 'Free',
        imageUrl: 'https://images.unsplash.com/photo-1614729939124-032f0b56c9ce?w=800&q=80',
        url: '#'
    }
]
            ...
            <div className="max-w-6xl mx-auto relative z-10">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                    {PRODUCTS.map(product => (
                        <div key={product.id} className="glass-card rounded-3xl overflow-hidden flex flex-col group border border-white/5 hover:border-peach/30 transition-all duration-300">
                            ...
                            <div className="p-8 flex flex-col flex-1">
                                ...
                                >
                                    {product.price === 'Free' ? (
                                        ...
                                        <>Get Access <ExternalLink size={16} className="group-hover/btn:translate-x-1 group-hover/btn:-translate-y-1 transition-transform" /></>
                                    )}
                                </a>
                            </div>
                        </div>
