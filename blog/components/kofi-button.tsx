...
const KOFI_URL = 'https://ko-fi.com/linkdinger' // TODO: Replace with your Ko-fi URL

export default function KofiButton({ variant = 'inline', className = '' }: KofiButtonProps) {
    if (variant === 'floating') {
        return (
            <a
                href={KOFI_URL}
                ...
                className={`fixed bottom-6 right-6 z-50 group flex items-center gap-2 px-4 py-3 rounded-full 
